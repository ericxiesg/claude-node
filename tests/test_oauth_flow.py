...
r = c.post(f"{BASE}/oauth/login", data={**params, "username": "eric", "password": "wrong"})
assert r.status_code == 401, r.status_code
print("3. wrong password rejected")

# 4. correct password
r = c.post(f"{BASE}/oauth/login", data={**params, "username": "eric", "password": "correct-horse-battery"})
